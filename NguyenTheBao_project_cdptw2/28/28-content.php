...
<div class="container type28">
	<div class="row">
		<div class="col-md-6 size-service">
			<div class="our-service"><h3>WE ARE A PASSIONATE FROM <span class="color-team">X-TEMOS</span> STUDIO.</h3></div>
			...
			<div class="our-service"><h3>DO BEAUTIFUL AND EASY-TO-USE DIGITAL USE.</h3></div>
		...
		<div class="hes-gallery">
			...
			<div class="team"><h3 class="our-service team-support">Team Support</h3></div>
		 	<div class="swiper-container">
			    <div class="swiper-wrapper">
			      <div class="swiper-slide">
			      	<img src="images/1.jpg" alt="image1" data-fullsize="images/1.jpg" 
			      	data-subtext='Support1 Emplooyee' class="img-responsive img-service">
			      </div>
			      <div class="swiper-slide">
			      	<img src="images/2.jpg" alt="" class="img-responsive img-service" data-subtext='Support2 Emplooyee'>
			      </div>
			      <div class="swiper-slide">
			      	<img src="images/3.png" alt="" class="img-responsive img-service" data-subtext='Support3 Emplooyee'>
			      </div>
			    </div>
			    <!-- Add Pagination -->
